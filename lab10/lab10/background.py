...
class TileBackground:
    ...
    def draw(self):
        ...
        self.tile_map.clip_draw_to_origin(x,y,w,self.height,0,0)
        self.tile_map.clip_draw_to_origin(0,y,self.width-w,self.height-y,w,0)
